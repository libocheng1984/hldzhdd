 ...
 */
	...
	$params = 'operation=PlanManagement_ModifyEvent_v001&license=' . $license.'&content=';
	...
	$res = $plan->updateEventPlan($interfaceUrl,$params,$yabh,$ajbt,$ajlb,$ajjb,$yalb,$czjb,$yatx,$_SESSION["userId"],$_SESSION["orgCode"],$fileData,$nrmc,$userId);//调用实例方法
	if($res['code']=="1"){
		 if(is_file($url)){
		 	@unlink ($url);
		 }
