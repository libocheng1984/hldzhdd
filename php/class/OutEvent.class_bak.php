...
class OutEvent extends TpmsDB {
	...
	* 添加警情单
	*/
	public function insertEvent($jqid,$jqbh,$jjlx,$jjfs,$bjfs,$bjsj,$jqdd,$bjnr,$jqlbdm,$jqlxdm,$jqxldm,$jqdjdm,$bjrxm,$bjrsfzh,$bjrxbdm,$bjdh,$lxdh,$bjdhyhxm,$bjdhyhdz,$jjrbh,$jjsj,$hzsj,$cjdbh,$stationhouseCode,$stationhouse) {
		$bRet = true;
		$errMsg = '';
		$event = '';
