...
$xtmc = urlencode("大连市智能指挥调度系统");
$url = $out_url . '?operation=AuthManagement_GetResourceByAccount_v001&' . 'license=' . $license . '&content={"data":[{"ResourceSysName":"'.$xtmc.'","Account":"' . $userId . '"}],"pageindex":0,"pagesize":999999}';
//echo $url;
