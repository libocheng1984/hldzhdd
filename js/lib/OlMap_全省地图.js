...
function OlMap(){
	this.mapInitialize=function(mapId,center,zoom){
		if(!arguments[1]){
	 	  	center = new OpenLayers.LonLat(123.443141,41.800907);
	 	}
  		if(!arguments[2]) {
  			zoom = 2;
  		}
		...
		var wmts2 = new OpenLayers.Layer.WMTS({
	        ...
	        matrixSet: "EPSG:4490",
	        //matrixIds: ['EPSG:4490_LNDTL02:0','EPSG:4490_LNDTL02:1','EPSG:4490_LNDTL02:2','EPSG:4490_LNDTL02:3','EPSG:4490_LNDTL02:4','EPSG:4490_LNDTL02:5','EPSG:4490_LNDTL02:6','EPSG:4490_LNDTL02:7','EPSG:4490_LNDTL02:8','EPSG:4490_LNDTL02:9'],
		...
		var wmts3 = new OpenLayers.Layer.WMTS({
	        ...
	        matrixSet: "EPSG:4490",
	        //matrixIds: ['EPSG:4490_LNDTL03:0','EPSG:4490_LNDTL03:1'],
	        //matrixIds: [0,1],
	        format: "image/png",
	        zoomOffset:-14,
	        tileOrigin:new OpenLayers.LonLat(-180,90),
		...
		mapObj.addLayers([wmts1,wmts2,wmts3,layer,layer1/*,layer2,layer3,layer4,layer5,layer6*/,layer7]);
